...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Client', fields ['unifi_controller']
        db.delete_unique('client', ['unifi_controller_id'])


        # Changing field 'Client.unifi_controller'
        db.alter_column('client', 'unifi_controller_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['unifi_control.UnifiController']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Client.unifi_controller'
        db.alter_column('client', 'unifi_controller_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['unifi_control.UnifiController']))
        # Adding unique constraint on 'Client', fields ['unifi_controller']
        db.create_unique('client', ['unifi_controller_id'])
