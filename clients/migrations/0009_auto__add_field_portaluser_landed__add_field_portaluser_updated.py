...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortalUser.landed'
        db.add_column('portal_user', 'landed',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now(), blank=True),
                      keep_default=False)

        # Adding field 'PortalUser.updated'
        db.add_column('portal_user', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=timezone.now(), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortalUser.landed'
        db.delete_column('portal_user', 'landed')

        # Deleting field 'PortalUser.updated'
        db.delete_column('portal_user', 'updated')
