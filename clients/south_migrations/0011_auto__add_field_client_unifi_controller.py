...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.unifi_controller'
        db.add_column('client', 'unifi_controller',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='clients', unique=True, null=True, to=orm['unifi_control.UnifiController']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.unifi_controller'
        db.delete_column('client', 'unifi_controller_id')
    ...
    models = {
        u'clients.client': {
            ...
            'unifi_controller': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'clients'", 'unique': 'True', 'null': 'True', 'to': u"orm['unifi_control.UnifiController']"}),
