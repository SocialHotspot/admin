...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortalUser.ua'
        db.add_column('portal_user', 'ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PortalUser.ip'
        db.add_column('portal_user', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortalUser.ua'
        db.delete_column('portal_user', 'ua')

        # Deleting field 'PortalUser.ip'
        db.delete_column('portal_user', 'ip')
